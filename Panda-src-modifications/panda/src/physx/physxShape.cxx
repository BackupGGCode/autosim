...
////////////////////////////////////////////////////////////////////
//     Function: PhysxShape::get_global_pos
//       Access: Published
//  Description: Retrieve the position of the shape in actor space,
//               i.e. relative to the actor it is owned by. 
////////////////////////////////////////////////////////////////////
...
get_global_pos() const {
	nassertr(_error_type == ET_ok, LPoint3f::zero());
	return PhysxManager::nxVec3_to_point3(ptr()->getGlobalPosition());
}
...
////////////////////////////////////////////////////////////////////
LQuaternionf PhysxShape::
get_global_quat() const {

  nassertr(_error_type == ET_ok, LQuaternionf::zero());
  return PhysxManager::nxQuat_to_quat(ptr()->getGlobalOrientation());
}
...
////////////////////////////////////////////////////////////////////
//     Function: PhysxShape::get_global_pose
//       Access: Published
...
get_global_pose() const {
  ...
  return PhysxManager::nxMat34_to_mat4(ptr()->getGlobalPose());
}
